export const openFormButton = document.querySelector(".profile__info-button");
export const openCardFormButton = document.querySelector(
  ".profile__add-button"
);
export const cardSpace = document.querySelector(".photo-cards");
export const formElement = document.querySelectorAll(".popup__form"); //Selector de formularios
